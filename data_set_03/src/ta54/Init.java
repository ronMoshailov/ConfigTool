...
import ta54.GreenWave;

public class Init implements enp.Initialisierung {

	public static String anlagenName = " Tel-Aviv Junc. 54";
	public static String tk1Name     = " Yehuda Halevi / Yavne / Shadal";
	public static String version     = " V1.4.1a G4qr.2-p1 V1.1";
	public static String date        = " 22/10/2020";
	public static String editor      = " Shachar";
...
//		SK24 sk2 = new SK24(2, (HwTeilknoten)Var.hwTk1);
		...
		new SchaltKanal(Var.tk1.pa     , Move.lred,   hwRed200  , Hw.HF, sk1,13, Hw.SK);
		new SchaltKanal(Var.tk1.pa     , Move.lgreen, hwGreen200, Hw.HF, sk1,14, Hw.SK);
		new SchaltKanal(Var.tk1.pb     , Move.lred,   hwRed200  , Hw.HF, sk1,15, Hw.SK);
		new SchaltKanal(Var.tk1.pb     , Move.lgreen, hwGreen200, Hw.HF, sk1,16, Hw.SK);
		new SchaltKanal(Var.tk1.pc     , Move.lred,   hwRed200  , Hw.HF, sk1,17, Hw.SK);
		new SchaltKanal(Var.tk1.pc     , Move.lgreen, hwGreen200, Hw.HF, sk1,18, Hw.SK);
		new SchaltKanal(Var.tk1.pd     , Move.lred,   hwRed200  , Hw.HF, sk1,19, Hw.SK);
		new SchaltKanal(Var.tk1.pd     , Move.lgreen, hwGreen200, Hw.HF, sk1,20, Hw.SK);
		new SchaltKanal(Var.tk1.pe     , Move.lred,   hwRed200  , Hw.HF, sk1,21, Hw.SK);
		new SchaltKanal(Var.tk1.pe     , Move.lgreen, hwGreen200, Hw.HF, sk1,22, Hw.SK);
...
//		new SchaltKanal(Var.tk1.Bc     , Move.lamber_nuge, hwAmber200, Hw.HF, sk1,16, Hw.KK);
...
//			new IoKanal (Var.tk1.e_3 .mapInput      , io64,  11);
//			new IoKanal (Var.tk1.tp_a.mapInput      , io64,  13);
//			new IoKanal (Var.tk1.tp_b.mapInput      , io64,  14);
			
//			new IoKanal (Var.tk1.tp_b               , io64,  31);
...
//			new IoKanal (SpecialInOuts.checkPuls    , io64, 39); // pulse for checking preemption application
			...
			new IoKanal (Var.tk1.pa .rm_gr			, io64, 47); 
			new IoKanal (Var.tk1.pb .rm_gr			, io64, 48); 
			new IoKanal (Var.tk1.pc .rm_gr			, io64, 49); 
			new IoKanal (Var.tk1.pd .rm_gr			, io64, 50);
			new IoKanal (Var.tk1.pe .rm_gr			, io64, 51);
