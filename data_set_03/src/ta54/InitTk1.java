...
public class InitTk1 extends InitTk {
	...
	public void initialisiereSg()
	{
		...
		tk.k3   	=  new Move(     tk  , "_3" ,  MoveType.Traffic			,		1 ,   0 , true);
		tk.k4   	=  new Move(     tk  , "_4" ,  MoveType.Traffic			,		1 ,   0 , true);

		tk.pa		=  new Move(     tk  , "_a"	,  MoveType.Pedestrian		,		6 ,   0 , false); 
		tk.pb		=  new Move(     tk  , "_b"	,  MoveType.Pedestrian		,		6 ,   0 , false); 
		tk.pc		=  new Move(     tk  , "_c"	,  MoveType.Pedestrian		,		6 ,   0 , false); 
		tk.pd		=  new Move(     tk  , "_d"	,  MoveType.Pedestrian		,		6 ,   0 , false); 
		tk.pe		=  new Move(     tk  , "_e"	,  MoveType.Pedestrian		,		6 ,   0 , false); 
...
//		tk.Bc		=  new Move(     tk  , "_Bc",  MoveType.Blinker_Conditional,	0 ,   0 , true );
	...
	public void initialisiereZwz()
	{
        ...
        tk.zwz.setzeZwz( tk.k1    , tk.pa     ,  7  ,  11 );
        tk.zwz.setzeZwz( tk.k1    , tk.pb     ,  7  ,   6 );
        tk.zwz.setzeZwz( tk.k1    , tk.pc     ,  5  ,  14 );
        
        tk.zwz.setzeZwz( tk.k2    , tk.pd     ,  7  ,   5 );
        tk.zwz.setzeZwz( tk.k2    , tk.pe     ,  5  ,  14 );  
        
        tk.zwz.setzeZwz( tk.k3    , tk.pa     ,  5  ,  12 );
        tk.zwz.setzeZwz( tk.k3    , tk.pc     ,  7  ,  13 );
        
        tk.zwz.setzeZwz( tk.k4    , tk.pe     ,  5  ,  14 );
...
//		tk.PB   = new Output( tk , "PB");
	...
	public void initialisiereProgs(){
		...
		tk.p01         = new VAProg(    tk         , "P01"   ,   1  ,    90 ,    39 ,    39 ,      999 ,   0 );// 1 - ACTIVE
		tk.p02         = new VAProg(    tk         , "P02"   ,   2  ,   100 ,    39 ,    39 ,      999 ,   0 );// 2 - ACTIVE
		tk.p03         = new VAProg(    tk         , "P03"   ,   3  ,    75 ,    39 ,    39 ,      999 ,   0 );// 3 - ACTIVE
		tk.p04         = new VAProg(    tk         , "P04"   ,   4  ,    90 ,    39 ,    39 ,      999 ,   0 );// 4 - P01
		tk.p05         = new VAProg(    tk         , "P05"   ,   5  ,    90 ,    39 ,    39 ,      999 ,   0 );// 5 - P01
		tk.p06         = new VAProg(    tk         , "P06"   ,   6  ,    90 ,    39 ,    39 ,      999 ,   0 );// 6 - P01
		tk.p07         = new VAProg(    tk         , "P07"   ,   7  ,    90 ,    39 ,    39 ,      999 ,   0 );// 7 - P01
		tk.p08         = new VAProg(    tk         , "P08"   ,   8  ,    90 ,    39 ,    39 ,      999 ,   0 );// 8 - P01
		tk.p09         = new VAProg(    tk         , "P09"   ,   9  ,    90 ,    39 ,    39 ,      999 ,   0 );// 9 - P01
		tk.p10         = new VAProg(    tk         , "P10"   ,  10  ,    90 ,    39 ,    39 ,      999 ,   0 );//10 - P01
		tk.p11         = new VAProg(    tk         , "P11"   ,  11  ,    90 ,    39 ,    39 ,      999 ,   0 );//11 - P01
		tk.p12         = new VAProg(    tk         , "P12"   ,  12  ,    90 ,    39 ,    39 ,      999 ,   0 );//12 - P01
		tk.p13         = new VAProg(    tk         , "P13"   ,  13  ,    90 ,    39 ,    39 ,      999 ,   0 );//13 - P01
		tk.p14         = new VAProg(    tk         , "P14"   ,  14  ,    90 ,    39 ,    39 ,      999 ,   0 );//14 - P01
		tk.p15         = new VAProg(    tk         , "P15"   ,  15  ,    90 ,    39 ,    39 ,      999 ,   0 );//15 - P01
		tk.p16         = new VAProg(    tk         , "P16"   ,  16  ,    90 ,    39 ,    39 ,      999 ,   0 );//16 - P01
		tk.p17         = new VAProg(    tk         , "P17"   ,  17  ,    90 ,    39 ,    39 ,      999 ,   0 );//17 - P01
		tk.p18         = new VAProg(    tk         , "P18"   ,  18  ,    90 ,    39 ,    39 ,      999 ,   0 );//18 - P01
		tk.p19         = new VAProg(    tk         , "P19"   ,  19  ,    90 ,    39 ,    39 ,      999 ,   0 );//19 - P01
		tk.p20         = new VAProg(    tk         , "P20"   ,  20  ,    90 ,    39 ,    39 ,      999 ,   0 );//20 - P01
		tk.p21         = new VAProg(    tk         , "P21"   ,  21  ,    90 ,    39 ,    39 ,      999 ,   0 );//21 - P01
		tk.p22         = new VAProg(    tk         , "P22"   ,  22  ,    90 ,    39 ,    39 ,      999 ,   0 );//22 - P01
		tk.p23         = new VAProg(    tk         , "P23"   ,  23  ,    90 ,    39 ,    39 ,      999 ,   0 );//23 - P01
		tk.p24         = new VAProg(    tk         , "P24"   ,  24  ,    90 ,    39 ,    39 ,      999 ,   0 );//24 - P01
		tk.p25         = new VAProg(    tk         , "P25"   ,  25  ,    90 ,    39 ,    39 ,      999 ,   0 );//25 - P01
		tk.p26         = new VAProg(    tk         , "P26"   ,  26  ,    90 ,    39 ,    39 ,      999 ,   0 );//26 - P01
		tk.p27         = new VAProg(    tk         , "P27"   ,  27  ,    90 ,    39 ,    39 ,      999 ,   0 );//27 - P01
		tk.p28         = new VAProg(    tk         , "P28"   ,  28  ,    90 ,    39 ,    39 ,      999 ,   0 );//28 - P01
		tk.p29         = new VAProg(    tk         , "P29"   ,  29  ,    90 ,    39 ,    39 ,      999 ,   0 );//29 - P01
		tk.p30         = new VAProg(    tk         , "P30"   ,  30  ,    90 ,    39 ,    39 ,      999 ,   0 );//30 - P01
		tk.p31         = new VAProg(    tk         , "P31"   ,  31  ,    90 ,    39 ,    39 ,      999 ,   0 );//31 - P01
		tk.p32         = new VAProg(    tk         , "P32"   ,  32  ,    90 ,    39 ,    39 ,      999 ,   0 );//32 - P01
...
//			tk.police_fixed = new MyHandProgramm(tk, "Police", SpecialProgram.Police.getProgramNumber(), 70,  1,  1, 999, 0);
	...
	public void initialisierePhasen(){
		...
		tk.MainPhase = tk.PhA = new PhaseA(tk, "PhaseA"            ,    10 , new int[] { 10 }, new int[] { 2 } , false      , new Move[] {tk.k1, tk.k2, tk.k3, tk.k4});
		
		//                               node| name			| number | skel | sp | is stop in | moves
		//                                   |				|        | len  | sp | Police     | list
		tk.PhEQA      = new PhaseEQA      (tk, "PhaseEQA"	,     11 ,    4 ,  1 , true       , new Move[] {tk.k1, tk.k2, tk.k3, tk.k4});
		tk.PhB        = new PhaseB        (tk, "PhaseB"		,     20 ,    6 ,  2 , true       , new Move[] {tk.pa, tk.pb, tk.pc, tk.pd, tk.pe});
		// Interstages                 
		//                             		node| name			|  len | stage out | stage in
		tk.PhueEQA_B	= new PhueEQAB		(tk, "PhueEQAB"		,    7 , tk.PhEQA  , tk.PhB 	);
		tk.PhueB_A     	= new PhueBA		(tk, "PhueBA"		,   14 , tk.PhB    , tk.PhA     );
	...
	public void initialisiereUhr(){
		//time table
		TagesPlan sunday = new TagesPlan("Sunday", tk.p03);
		sunday.initProgWunsch( 6 , 00,  tk.p01 );
		sunday.initProgWunsch(10 , 00,  tk.p02 );
		sunday.initProgWunsch(20 , 00,  tk.p03 );

		TagesPlan monday = new TagesPlan("Monday", tk.p03);
		monday.initProgWunsch( 6 , 00,  tk.p01 );
		monday.initProgWunsch(10 , 00,  tk.p02 );
		monday.initProgWunsch(21 , 00,  tk.p03 );

		TagesPlan tuesday = new TagesPlan("Tuesday", tk.p03);
		tuesday.initProgWunsch( 6 , 00,  tk.p01 );
		tuesday.initProgWunsch(10 , 00,  tk.p07 );
		tuesday.initProgWunsch(22 , 00,  tk.p06 );

		TagesPlan wednesday = new TagesPlan("Wednesday", tk.p03);
		wednesday.initProgWunsch( 6 , 00,  tk.p01 );
		wednesday.initProgWunsch(10 , 00,  tk.p05 );
		wednesday.initProgWunsch(23 , 00,  tk.p04 );

		TagesPlan thursday = new TagesPlan("Thurday", tk.p03);
		thursday.initProgWunsch( 6 , 00,  tk.p01 );
		thursday.initProgWunsch(10 , 00,  tk.p02 );
		thursday.initProgWunsch(20 , 00,  tk.p03 );

		TagesPlan fr = new TagesPlan("Fr", tk.p03);
		fr.initProgWunsch( 6 , 00,  tk.p01 );
		fr.initProgWunsch(10 , 00,  tk.p02 );
		fr.initProgWunsch(17 , 00,  tk.p03 );

		TagesPlan sa = new TagesPlan("Sat", tk.p03);
		sa.initProgWunsch( 0 ,  0,  tk.p03 );

		TagesPlan kipurEve = new TagesPlan("KipurEve", tk.p03);
		kipurEve.initProgWunsch( 6 , 00,  tk.p01 );
		kipurEve.initProgWunsch(10 , 00,  tk.p02 );
		kipurEve.initProgWunsch(17 , 00,  tk.p03 );

		TagesPlan kipur = new TagesPlan("Kipur", tk.p03 );
		kipur.initProgWunsch( 0 ,  0,  tk.p03 );
