...
//                      |          | starting | ->ending
	tk.zwz.setzeZwz( tk.k1	, tk.k3	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k3	, tk.k1	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k3	, tk.k1	,	1	,	1	);
	    tk.zwz.setzeZwz( tk.k1	, tk.k3	,	1	,	1	);
	...
	tk.zwz.setzeZwz( tk.pa	, tk.k1	,	11	,	5	);
	tk.zwz.setzeZwz( tk.pa	, tk.k1	,	11	,	5	);
	tk.zwz.setzeZwz( tk.k1	, tk.pa	,	5	,	11	);
	tk.zwz.setzeZwz( tk.pa	, tk.k1	,	11	,	5	);
	tk.zwz.setzeZwz( tk.k1	, tk.pa	,	5	,	11	);
	tk.zwz.setzeZwz( tk.k1	, tk.pa	,	5	,	11	);
	tk.zwz.setzeZwz( tk.pa	, tk.k1	,	11	,	5	);
	tk.zwz.setzeZwz( tk.k2	, tk.k3	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k3	, tk.k2	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k3	, tk.k2	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k2	, tk.k3	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k3	, tk.k2	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k2	, tk.k3	,	1	,	1	);
	...
	tk.zwz.setzeZwz( tk.pa	, tk.k2	,	10	,	6	);
	tk.zwz.setzeZwz( tk.pa	, tk.k2	,	10	,	6	);
	tk.zwz.setzeZwz( tk.k2	, tk.pa	,	6	,	10	);
	tk.zwz.setzeZwz( tk.pa	, tk.k2	,	10	,	6	);
	tk.zwz.setzeZwz( tk.k2	, tk.pa	,	6	,	10	);
	...
	tk.zwz.setzeZwz( tk.pc	, tk.k3	,	6	,	7	);
	tk.zwz.setzeZwz( tk.pc	, tk.k3	,	6	,	7	);
	tk.zwz.setzeZwz( tk.k3	, tk.pc	,	7	,	6	);
	tk.zwz.setzeZwz( tk.pc	, tk.k3	,	6	,	7	);
	tk.zwz.setzeZwz( tk.k3	, tk.pc	,	7	,	6	);
	...
	tk.zwz.setzeZwz( tk.pd	, tk.k3	,	11	,	5	);
	tk.zwz.setzeZwz( tk.pd	, tk.k3	,	11	,	5	);
	tk.zwz.setzeZwz( tk.k3	, tk.pd	,	5	,	11	);
	tk.zwz.setzeZwz( tk.pd	, tk.k3	,	11	,	5	);
	tk.zwz.setzeZwz( tk.k3	, tk.pd	,	5	,	11	);
	tk.zwz.setzeZwz( tk.k3	, tk.pd	,	5	,	11	);
	tk.zwz.setzeZwz( tk.pd	, tk.k3	,	11	,	5	);
	tk.zwz.setzeZwz( tk.k1	, tk.k2	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k2	, tk.k1	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k2	, tk.k1	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k1	, tk.k2	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k2	, tk.k1	,	1	,	1	);
	tk.zwz.setzeZwz( tk.k1	, tk.k2	,	1	,	1	);
...
tk.d1 	  = new DDetector ( "D1"    , tk.k1 , true    , true        , true );
tk.e1 	  = new EDetector ( "E1"    , tk.k1 , true    , true        , true );
tk.d2 	  = new DDetector ( "D2"    , tk.k1 , true    , true        , true );
//		tk.e2 	  = new EDetector ( "E2"    , tk.k1 , true    , true        , true );
...
tk.p01         = new VAProg(  tk , "P01" ,  1  ,   120 ,     7 ,     7 ,      999 ,   0 ); // 1 - ACTIVE
tk.p02         = new VAProg(  tk , "P02" ,  2  ,   100 ,     7 ,     7 ,      999 ,   0 ); // 2 - ACTIVE
tk.p03         = new VAProg(  tk , "P03" ,  3  ,   110 ,     7 ,     7 ,      999 ,   0 ); // 3 - ACTIVE
tk.p04         = new VAProg(  tk , "P04" ,  4  ,   110 ,     7 ,     7 ,      999 ,   0 ); // 4 - ACTIVE
tk.p05         = new VAProg(  tk , "P05" ,  5  ,   120 ,     7 ,     7 ,      999 ,   0 ); // 5 - ACTIVE
tk.p06         = new VAProg(  tk , "P06" ,  6  ,   120 ,     7 ,     7 ,      999 ,   0 ); // 6 - ACTIVE
tk.p07         = new VAProg(  tk , "P07" ,  7  ,    90 ,     7 ,     7 ,      999 ,   0 ); // 7 - ACTIVE
tk.p08         = new VAProg(  tk , "P08" ,  8  ,   110 ,     7 ,     7 ,      999 ,   0 ); // 8 - ACTIVE
tk.p09         = new VAProg(  tk , "P09" ,  9  ,   120 ,     7 ,     7 ,      999 ,   0 ); // 9 - ACTIVE
tk.p10         = new VAProg(  tk , "P10" , 10  ,   100 ,     7 ,     7 ,      999 ,   0 ); //10 - ACTIVE
tk.p11         = new VAProg(  tk , "P11" , 11  ,   100 ,     7 ,     7 ,      999 ,   0 ); //11 - ACTIVE
tk.p12         = new VAProg(  tk , "P12" , 12  ,   120 ,     7 ,     7 ,      999 ,   0 ); //12 - ACTIVE
tk.p13         = new VAProg(  tk , "P13" , 13  ,    90 ,     7 ,     7 ,      999 ,   0 ); //13 - ACTIVE
tk.p14         = new VAProg(  tk , "P14" , 14  ,   110 ,     7 ,     7 ,      999 ,   0 ); //14 - ACTIVE
tk.p15         = new VAProg(  tk , "P15" , 15  ,   120 ,     7 ,     7 ,      999 ,   0 ); //15 - ACTIVE

tk.p16         = new VAProg(  tk , "P16" , 16  ,   120 ,     7 ,     7 ,      999 ,   0 ); //16 - P01
tk.p17         = new VAProg(  tk , "P17" , 17  ,   120 ,     7 ,     7 ,      999 ,   0 ); //17 - P01
tk.p18         = new VAProg(  tk , "P18" , 18  ,   120 ,     7 ,     7 ,      999 ,   0 ); //18 - P01
tk.p19         = new VAProg(  tk , "P19" , 19  ,   120 ,     7 ,     7 ,      999 ,   0 ); //19 - P01
tk.p20         = new VAProg(  tk , "P20" , 20  ,   120 ,     7 ,     7 ,      999 ,   0 ); //20 - P01
tk.p21         = new VAProg(  tk , "P21" , 21  ,   120 ,     7 ,     7 ,      999 ,   0 ); //21 - P01
tk.p22         = new VAProg(  tk , "P22" , 22  ,   120 ,     7 ,     7 ,      999 ,   0 ); //22 - P01
tk.p23         = new VAProg(  tk , "P23" , 23  ,   120 ,     7 ,     7 ,      999 ,   0 ); //23 - P01
tk.p24         = new VAProg(  tk , "P24" , 24  ,   120 ,     7 ,     7 ,      999 ,   0 ); //24 - P01
tk.p25         = new VAProg(  tk , "P25" , 25  ,   120 ,     7 ,     7 ,      999 ,   0 ); //25 - P01
tk.p26         = new VAProg(  tk , "P26" , 26  ,   120 ,     7 ,     7 ,      999 ,   0 ); //26 - P01
tk.p27         = new VAProg(  tk , "P27" , 27  ,   120 ,     7 ,     7 ,      999 ,   0 ); //27 - P01
tk.p28         = new VAProg(  tk , "P28" , 28  ,   120 ,     7 ,     7 ,      999 ,   0 ); //28 - P01
tk.p29         = new VAProg(  tk , "P29" , 29  ,   120 ,     7 ,     7 ,      999 ,   0 ); //29 - P01
tk.p30         = new VAProg(  tk , "P30" , 30  ,   120 ,     7 ,     7 ,      999 ,   0 ); //30 - P01
tk.p31         = new VAProg(  tk , "P31" , 31  ,   120 ,     7 ,     7 ,      999 ,   0 ); //31 - P01
tk.p32         = new VAProg(  tk , "P32" , 32  ,   120 ,     7 ,     7 ,      999 ,   0 ); //32 - P01

//		tk.p31         = new VAProg(  tk , "P31" , 31  ,    90 ,     2 ,     2 ,      999 ,   0 ); //31 - SK
//		tk.p32         = new VAProg(  tk , "P32" , 32  ,     0 ,     0 ,     0 ,      999 ,   0 ); //32 - 0
...
tk.PhueB_A	   = new PhueB_A   	  (tk, "PhueB_A"   ,  99 , tk.PhB	 , tk.PhA     );
