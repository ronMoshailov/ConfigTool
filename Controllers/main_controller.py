...
class MainController:
    ...
    def _initialize_app(self):
        ...
        self.path_manager.set_files_path(self.phue_model.phue_paths)                                                # set files of use
        self.settings_controller.init_model(self.path_manager.path_init)                                            # init settings moves
        self.sk_controller.init_model(self.path_manager.path_init)                                                  # init sk moves
        self.move_controller.init_model(self.path_manager.path_init_tk1)                                            # init project moves
        self.detector_controller.init_model(self.path_manager.path_init_tk1)                                        # init detectors moves
        self.image_controller.init_model(self.path_manager.path_init_tk1, self.move_model.get_all_moves_names())    # init images moves
        self.phue_controller.init_model(self.phue_model.phue_paths, self.path_manager.path_init_tk1)                # init phue moves
        self.matrix_controller.init_model(self.path_manager.path_init_tk1)                                          # init matrix
    ...
    def write_imports(self):
        ...
        with open(self.path_manager.path_init_tk1_dst, 'r', encoding='utf-8') as f:
            lines = f.readlines()
