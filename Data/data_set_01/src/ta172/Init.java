...
public class Init implements enp.Initialisierung {
	...
	public static String anlagenName = " Tel-Aviv Junc. 172";
	public static String tk1Name     = " HaShalomn / HaTayasim";
	public static String version     = " V1.4.1e G4qr.2-p1 V7.1";
//	public static String date        = " 12/12/2022";
//	public static String editor      = " Liroy M.";
...
// 		new SchaltKanal(Var.tk1.k1     , Move.lgreen, hwGreen200, Hw.HF, sk1, 3, Hw.SK);
		...
		new SchaltKanal(Var.tk1.k5     , Move.lred,   hwRed200  , Hw.HF, sk1, 7, Hw.SK);
		new SchaltKanal(Var.tk1.k5     , Move.lamber, hwAmber200, Hw.HF, sk1, 8, Hw.SK);
		new SchaltKanal(Var.tk1.k5     , Move.lgreen, hwGreen200, Hw.HF, sk1, 9, Hw.SK);
		new SchaltKanal(Var.tk1.k6     , Move.lred,   hwRed200  , Hw.HF, sk1,10, Hw.SK);
		new SchaltKanal(Var.tk1.k6     , Move.lamber, hwAmber200, Hw.HF, sk1,11, Hw.SK);
		new SchaltKanal(Var.tk1.k6     , Move.lgreen, hwGreen200, Hw.HF, sk1,12, Hw.SK);
		new SchaltKanal(Var.tk1.k7     , Move.lred,   hwRed200  , Hw.HF, sk1,13, Hw.SK);
		new SchaltKanal(Var.tk1.k7     , Move.lamber, hwAmber200, Hw.HF, sk1,14, Hw.SK);
		new SchaltKanal(Var.tk1.k7     , Move.lgreen, hwGreen200, Hw.HF, sk1,15, Hw.SK);
		new SchaltKanal(Var.tk1.k8     , Move.lred,   hwRed200  , Hw.HF, sk1,16, Hw.SK);
		new SchaltKanal(Var.tk1.k8     , Move.lamber, hwAmber200, Hw.HF, sk1,17, Hw.SK);
		new SchaltKanal(Var.tk1.k8     , Move.lgreen, hwGreen200, Hw.HF, sk1,18, Hw.SK);
		...
		new SchaltKanal(Var.tk1.Bi     , Move.lamber_nuge, hwAmber200, Hw.HF, sk2,12, Hw.KK);
		new SchaltKanal(Var.tk1.Bj     , Move.lamber_nuge, hwAmber200, Hw.HF, sk2,13, Hw.KK);
		new SchaltKanal(Var.tk1.Bk     , Move.lamber_nuge, hwAmber200, Hw.HF, sk2,14, Hw.KK);
