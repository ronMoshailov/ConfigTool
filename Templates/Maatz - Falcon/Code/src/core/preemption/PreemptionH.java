...
// *                                                                                              *
// ************************************************************************************************/
//import parameters.ParamSetHaifa;
//import core.InterStage;
//import core.Move;
//import core.Node;
//import core.Stage;
//import core.detectors.DPTDetector;
//import m0.Var;
//import det.Det;
//import det.Detektor;
//import sg.Sg;
...
//import vt.Phase;
//
//public abstract class PreemptionH extends Preemption
//{
//	private Node _tk;
...
//	public int[][] atCounters; // arrival time of each bus on each public transport signal group
//	public int[][] atTypes; // array to tell if counting DPT1 or DPT2 or DPT3
...
//	public int[][] dptData; // number of sg, DPT type (1-4), Logical Index of DPT, assumedTimeFromDetectionToTarget
...
//	}
//
//	public PreemptionH(Node tk, int actualDptQuantity, int extraDptQuantity, int brt_num, int brts_per_move, int dpt4_timoue, boolean isReset, int red_stages, int compMoves) {
//		_tk = tk;
...
//			if ( _tk.getLenPhue() == Stage.MAX_INTERSTAGE_DURATION && Phase.getAktivePhase(_tk).getPhasenZeit() == 1 * Var.ONE_SEC )
//				updateDetMem();
//
//		if (_tk.isRegularProgram()) {
//			EverySecond();
...
//			return null;
//
//		return (Move)Sg.getSgByNum(moveMap[index][0]);
//	}
//
...
//	}
//
//	// TODO update when code received (this is how it was written in "Bar Yehuda / Downtown")
...
//	}
//
//	public int CompareRedTimePhase( int red1, int red2)
//	{
//		if(red1==red2)
//			return red1;
//		if (red1 != CT_NONE && red2 != CT_NONE)
//			return Math.max(red1, red2);
//		return Math.min(red1, red2);
//	}
//
//
//	/**
...
//
//			int res = requestedComp - getCumulativeCycleGT( (Move)Sg.getSgByNum( move ), cycles ) + ((Move)Sg.getSgByNum( move )).GT() - (1*Var.ONE_SEC);/*Func.gt( Sg.getSgByNum( move ) ) - (1*Var.ONE_SEC)*/;
//
//			if ( res < 0 )
//			{
//				res = 0;
...
//	}
//
//	protected int NormMoveArrivalTime( int move ) {
//		int moveNormMoveAT = normMoveAT[ getBRTIndex( move )];
//
//	    return moveNormMoveAT;
//	}
//	
//	/**
...
//	}
//
//	public static boolean isElementDeactivated(Sg name) {
//		if (name.getTyp() == Move.ped) //if type is ped
//		{
//			if ((name.getZustand() == Zustand.ROT) && (name.getZustSek() == 0))
//			{
//				return true;
//			}
//		}
//		else if (name.getTyp()== Move.car)//if type is car with green blink
//		{
//			if ((name.getZustand() == Zustand.GRUENBLINKUEB) && (name.getZustSek() == 0))
//			{
//				return true;
//			}
//			if ((name.getZustand() == Zustand.GELB) && (name.getZustSek() + 3000 == 0))
//			{
//				return true;
//			}
//			if ((name.getZustand() == Zustand.ROT) && (name.getZustSek() + 3000 + 3000 == 0))
//			{
//				return true;
//			}
//		}
//		else if (name.getTyp() == Move.car_ngb) //if type is car without green blink
//		{
//			if ((name.getZustand() == Zustand.GELB) && (name.getZustSek() == 0))
//			{
//				return true;
//			}
//			if ((name.getZustand() == Zustand.ROT) && (name.getZustSek() + 3000 == 0))
//			{
//				return true;
//			}
//		}
...
//		int cycle = ParamSetHaifa.pFixedCycleTime_ProgAtt;
//		if (_tk.getNummer() == 2)
//			cycle = ParamSetHaifa.pFixedCycleTime_ProgAtt2;
//
...
//			if (sg.getZustand() != Zustand.GRUEN && time <= 1*Var.ONE_SEC )
...
//	public int getNormCumCycleGT(int move, int cycles) {
//		int greenTime = 1000, index  = -1;
//
//		if ((index = getCompIndex(move)) == NONE) {
//			return greenTime;
//		}
//
//		if ( _tk.CycleCount + 1 >= cycles && _tk.CycleCount + 1 >= getCompMoveCumPeriod( move ) && compMoveDetMem[getCompIndex( move )] >= cycles && true )
//			greenTime = getCumulativeCycleGT( getCompMove(move), cycles );
//
//		return greenTime;
//	}
//
...
//
//
//	abstract public int InitializeDPT(int index);
