 ...
 *
 */
public class Dvi35Haifa extends iCentral {
    public Dvi35Haifa() {
        super("DVI35 [Haifa]", "2.1");
    }
...
//        }
    ...
    public static void checkPrccGW()
    {
		...
		if ((flagProgCC == true) && (node_1.greenwaveIsSYError() == false)
				&& (node_1.greenwaveIsGWEnabledProgram(node_1.getAktProg().getNummer()))
    ...
    public boolean isGreenWaveSY() {
        return checkExitFromA_Central();
    }

    public boolean isOperateGreenWaveSY() {
        return opmodecc == syccmode;
    }
}
