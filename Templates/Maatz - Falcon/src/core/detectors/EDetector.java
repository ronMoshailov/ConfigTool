...
public class EDetector extends Input {
     ...
     * @param move
     */
    public EDetector(String name, Move move, ParametersIndex param) {
        super(move.node, name, move, 4000);
        hasMapInput = true;
        node.extensions.add(this);
     ...
     * @param id
     */
    public EDetector(String name, Move move, ParametersIndex param, int id) {
    ...
    public EDetector setRemoteDetector() {
        return (EDetector)super.setRemoteDetector();
    }
