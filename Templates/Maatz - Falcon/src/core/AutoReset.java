...
public class AutoReset {
    ...
    public AutoReset(int delayBeforeReset, int maxTimeForCountersReset, int maxResetRetries) {
        ...
        maximumResetRetries = 0; // TODO change according to parameter
        System.out.println("Auto-Reset Module initialized [Retries = " + maxResetRetries + "]");
    }
    ...
    private boolean isMinOnTimeDone() {
        ...
        return currentTimeMS - errorStartTimeMS >= DelayBeforeReset * Var.ONE_SEC_MS;
    }
    ...
    private boolean isNewErrorTimeFrame() {
        ...
        return currentTimeMS - startupTimeMS >= MAXIMUM_TIME_FOR_COUNTERS_RESET * Var.ONE_SEC_MS;
    }
