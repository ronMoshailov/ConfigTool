 ...
 * @since 01/04/2015
 */
public class HaifaPTParameters extends Parameters {
    ...
    public int getGWEnable() {
        return parameters[PARAM_ISCROSSMASTER.getIndex() - 1];
    }
    
    public int getGWEnable(int nodeId) {
        if (nodeId == 2) {
            return parameters[PARAM_ISCROSSMASTER2.getIndex() - 1];
        } else {
            return parameters[PARAM_ISCROSSMASTER .getIndex() - 1];
        }
    }
