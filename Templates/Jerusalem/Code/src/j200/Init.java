...
public class Init implements enp.Initialisierung {
	...
	public static String anlagenName = " Jerusalem Junc. 200";
	public static String tk1Name     = " Plumer Square / King David / Keren HaYesod / Version 15";
	public static String version     = " V1.3.21b G5tf.7 V3.1";
	public static String date        = " 17/05/2026";
	public static String editor      = " Sergei V.";

	/*******************************************************************************************
	 * Versions:
	 * V1 - Basic Version - Last Update: 07.11.2018
	 *******************************************************************************************/
	...
	protected void initialisiereTk(){
		...
		Var.controller.SetAppType(AppType.Jerusalem);	// sets the type of application (Haifa/Netivei-Israel/Jerusalem....)
	...
	protected void initialisiereDet(){
		...
		Var.controller.upsActive      = new Input(Var.tk1, "UPS-Active"   , false, false, false);
		Var.controller.upsWeak        = new Input(Var.tk1, "UPS-Weak"     , false, false, false);
		Var.controller.upsWarning     = new Input(Var.tk1, "UPS-Warning"  , false, false, false);
		Var.controller.upsFailure     = new Input(Var.tk1, "UPS-Failure"  , false, false, false);
		Var.controller.upsInBypass    = new Input(Var.tk1, "UPS-In-Bypass", false, false, false);
		Var.controller.upsNoGridPower = new Input(Var.tk1, "UPS-GridPower", false, false, false);
		Var.controller.upsDoorClosed  = new Input(Var.tk1, "UPS-DoorClose", false, false, false);
	        
		if (Var.controller.isAppJerusalem() && Var.controller.isPreemption()) {
			Var.controller.sitDoorOpen = new Input(Var.tk1, "SIT-Door-Open", false, false, false);
		}
		...
		SpecialInOuts.initUpsInput(Var.tk1, SpecialInOuts.inactive);
	...
	protected void initialisiereHW(){
		...
		//switch cards
		SK24 sk1 = new SK24(1, (HwTeilknoten)Var.hwTk1);
		SK24 sk2 = new SK24(2, (HwTeilknoten)Var.hwTk1);
		...
		new SchaltKanal(Var.tk1.k10    , Move.lred,   hwRed200  , Hw.HF, sk1, 4, Hw.SK);
		new SchaltKanal(Var.tk1.k10    , Move.lamber, hwAmber200, Hw.HF, sk1, 5, Hw.SK);
		new SchaltKanal(Var.tk1.k10    , Move.lgreen, hwGreen200, Hw.HF, sk1, 6, Hw.SK);
		...
		new SchaltKanal(Var.tk1.ph     , Move.lred,   hwRed200  , Hw.HF, sk2, 9, Hw.SK);
		new SchaltKanal(Var.tk1.ph     , Move.lgreen, hwGreen200, Hw.HF, sk2,10, Hw.SK);
		...
		new SchaltKanal(Var.tk1.Bd     , Move.lamber_nuge, hwAmber200, Hw.HF, sk2,11, Hw.KK);
		new SchaltKanal(Var.tk1.Bg     , Move.lamber_nuge, hwAmber200, Hw.HF, sk2,12, Hw.KK);
		new SchaltKanal(Var.tk1.Bh     , Move.lamber_nuge, hwAmber200, Hw.HF, sk2,13, Hw.KK);
		new SchaltKanal(Var.tk1.Bl     , Move.lamber_nuge, hwAmber200, Hw.HF, sk2,14, Hw.KK);
...
//		new IoKanal (Var.tk1.e_6		  , io1,  1);

		new IoKanal (Var.controller.upsActive        , io1, 10);
		new IoKanal (Var.controller.upsWeak          , io1, 11);
		new IoKanal (Var.controller.upsWarning       , io1, 12);
		new IoKanal (Var.controller.upsFailure       , io1, 13);
		new IoKanal (Var.controller.upsInBypass      , io1, 14);
		new IoKanal (Var.controller.upsNoGridPower   , io1, 15);
		new IoKanal (Var.controller.upsDoorClosed    , io1, 16);
		
//		new IoKanal (Var.tk1.tp_a_a.feedback, io1, 17);
...
//			new IoKanal (Var.tk1.d1.mapInput        , io64,  11);
...
//			new IoKanal (Var.tk1.pj.rm_gr           , io64, 54);
//			new IoKanal (Var.tk1.pk.rm_gr           , io64, 55);
//			new IoKanal (Var.tk1.pl.rm_gr           , io64, 56);
		}
	...
	protected void initialisiereZentrale(){
		...
		if(Var.controller.isAppHaifa() || Var.controller.isAppJerusalem())
		{
			int central = 0;
