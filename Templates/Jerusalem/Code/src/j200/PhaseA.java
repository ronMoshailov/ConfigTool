...
public class PhaseA extends MainStage {
	...
	public int getMinExt() {
		...
		return 0; //ParametersJerusalem.GTmin_A_Duration;
	}
	...
	public int getMaxExt() {
		...
		return 0; //ParametersJerusalem.GTmax_A_Duration;
	}
	...
	public Phase phasenFunktionCycleStart() {
		...
		if (isStartStageDoneGwFixed())
		{
			return startNextPhase(node.PhueA_C);
		}
