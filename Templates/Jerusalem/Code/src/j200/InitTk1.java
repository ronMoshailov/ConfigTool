...
public class InitTk1 extends InitTk {
	...
	public void initialisiereSg()
	{
		...
		tk.k10    =  new Move(     tk  , "_10"	 ,  MoveType.Traffic   ,      6 ,   0 , true );
		tk.k3     =  new Move(     tk  , "_3"    ,  MoveType.Traffic   ,      6 ,   0 , true );
		...
		tk.pd     =  new Move(     tk  , "_d"    ,  MoveType.Pedestrian,      6 ,   0 , true ); 
		tk.pe     =  new Move(     tk  , "_e"    ,  MoveType.Pedestrian,      7 ,   0 , false);
		tk.pf     =  new Move(     tk  , "_f"    ,  MoveType.Pedestrian,      6 ,   0 , true );
		tk.pg     =  new Move(     tk  , "_g"    ,  MoveType.Pedestrian,      6 ,   0 , false);
		tk.ph     =  new Move(     tk  , "_h"    ,  MoveType.Pedestrian,      6 ,   0 , true );
		
		tk.Bd     =  new Move(     tk  , "_Bd"   ,  MoveType.Blinker_Conditional,   0 ,   0 ,	true );
		tk.Bg     =  new Move(     tk  , "_Bg"   ,  MoveType.Blinker_Conditional,   0 ,   0 ,	false);
		tk.Bh     =  new Move(     tk  , "_Bh"   ,  MoveType.Blinker_Conditional,   0 ,   0 ,	true );
		tk.Bl     =  new Move(     tk  , "_Bl"   ,  MoveType.Blinker			,   0 ,   0 ,	true );
	}
	...
	public void initialisiereZwz()
	{
		...
		//               ending | starting | end->start| start->end
        tk.zwz.setzeZwz( tk.k1    , tk.k5     ,  5  ,    6    );
        tk.zwz.setzeZwz( tk.k1    , tk.k6     ,  7  ,    7    );
        tk.zwz.setzeZwz( tk.k1    , tk.pb     ,  8  ,    3    );
        tk.zwz.setzeZwz( tk.k1    , tk.pe     ,  5  ,   10    );
        
        tk.zwz.setzeZwz( tk.k10   , tk.k4     ,  6  ,    4    );
        tk.zwz.setzeZwz( tk.k10   , tk.k5     ,  7  ,    6    );
        tk.zwz.setzeZwz( tk.k10   , tk.k6     ,  6  ,    6    );
        tk.zwz.setzeZwz( tk.k10   , tk.pa     ,  5  ,    6    );
        tk.zwz.setzeZwz( tk.k10   , tk.pe     ,  8  ,    7    );
        tk.zwz.setzeZwz( tk.k10   , tk.pg     ,  7  ,    5    );
        
        tk.zwz.setzeZwz( tk.k3    , tk.k4     ,  6  ,    4    );
        tk.zwz.setzeZwz( tk.k3    , tk.k5     ,  5  ,    6    );
        tk.zwz.setzeZwz( tk.k3    , tk.k6     ,  4  ,    6    );
        tk.zwz.setzeZwz( tk.k3    , tk.pa     ,  5  ,    6    );
        tk.zwz.setzeZwz( tk.k3    , tk.pg     ,  7  ,    5    );
                
        tk.zwz.setzeZwz( tk.k4    , tk.k6     ,  4  ,    7    );
        tk.zwz.setzeZwz( tk.k4    , tk.ph     ,  5  ,    9    );
        
        tk.zwz.setzeZwz( tk.k5    , tk.k6     ,  7  ,    6    );
        tk.zwz.setzeZwz( tk.k5    , tk.pb     ,  8  ,    3    );
        tk.zwz.setzeZwz( tk.k5    , tk.pd     ,  7  ,    6    );
        tk.zwz.setzeZwz( tk.k5    , tk.pf     ,  5  ,    8    );
        tk.zwz.setzeZwz( tk.k5    , tk.ph     ,  8  ,    7    );
        
        tk.zwz.setzeZwz( tk.k6    , tk.pc     ,  5  ,    8    );
        tk.zwz.setzeZwz( tk.k6    , tk.pe     ,  8  ,    8    );
        tk.zwz.setzeZwz( tk.k6    , tk.pg     ,  8  ,    5    );
        tk.zwz.setzeZwz( tk.k6    , tk.ph     ,  8  ,    6    );
	...
	public void initialisiereDet(){
		...
		// detectors
		//		                      Name   | SG    | Has DSY  | is call-all | SetFromParamsEnabled | detId | gapId
//		tk.e_6		= new EDetector	("E-6"   , tk.k6 ,    false , true, 		  true,					1);
		
		// inputs
		//                  Node | Name | Has DSY | is call-all | isSetFromParamsEnabled
//		tk.de   = new Input ( tk , "DE" ,  false  , false, 		  false);
//		tk.dp   = new Input ( tk , "DP" ,  false  , false, 		  false);

		// outputs
		//                  Node | Name
//		tk.S1   = new Output( tk , "S1");
//		tk.PB1  = new Output( tk , "PB1");
	...
	public void initialisiereProgs(){
		...
		tk.p01         = new VAProg(    tk         , "P01"   ,   1  ,   120 ,    16 ,    16 ,      999 ,   0 );// 1 - Active
		tk.p02         = new VAProg(    tk         , "P02"   ,   2  ,   120 ,    12 ,    12 ,      999 ,   0 );// 2 - Active
		tk.p03         = new VAProg(    tk         , "P03"   ,   3  ,   120 ,     6 ,     6 ,      999 ,   0 );// 3 - Active
		tk.p04         = new VAProg(    tk         , "P04"   ,   4  ,    80 ,    19 ,    19 ,      999 ,   0 );// 4 - Active
		tk.p05         = new VAProg(    tk         , "P05"   ,   5  ,   120 ,     5 ,     5 ,      999 ,   0 );// 5 - Active
		tk.p06         = new VAProg(    tk         , "P06"   ,   6  ,   120 ,     5 ,     5 ,      999 ,   0 );// 6 - Active
		tk.p07         = new VAProg(    tk         , "P07"   ,   7  ,   120 ,     5 ,     5 ,      999 ,   0 );// 7 - Active
		tk.p08         = new VAProg(    tk         , "P08"   ,   8  ,   120 ,    16 ,    16 ,      999 ,   0 );// 8 - P01
		tk.p09         = new VAProg(    tk         , "P09"   ,   9  ,   120 ,    16 ,    16 ,      999 ,   0 );// 9 - P01
		tk.p10         = new VAProg(    tk         , "P10"   ,  10  ,   120 ,    16 ,    16 ,      999 ,   0 );//10 - P01
		tk.p11         = new VAProg(    tk         , "P11"   ,  11  ,   120 ,    16 ,    16 ,      999 ,   0 );//11 - P01
		tk.p12         = new VAProg(    tk         , "P12"   ,  12  ,   120 ,    16 ,    16 ,      999 ,   0 );//12 - P01
		tk.p13         = new VAProg(    tk         , "P13"   ,  13  ,   120 ,    16 ,    16 ,      999 ,   0 );//13 - P01
		tk.p14         = new VAProg(    tk         , "P14"   ,  14  ,   120 ,    16 ,    16 ,      999 ,   0 );//14 - P01
		tk.p15         = new VAProg(    tk         , "P15"   ,  15  ,   120 ,    16 ,    16 ,      999 ,   0 );//15 - P01
		tk.p16         = new VAProg(    tk         , "P16"   ,  16  ,   120 ,    16 ,    16 ,      999 ,   0 );//16 - P01
		tk.p17         = new VAProg(    tk         , "P17"   ,  17  ,   120 ,    16 ,    16 ,      999 ,   0 );//17 - P01
		tk.p18         = new VAProg(    tk         , "P18"   ,  18  ,   120 ,    16 ,    16 ,      999 ,   0 );//18 - P01
		tk.p19         = new VAProg(    tk         , "P19"   ,  19  ,   120 ,    16 ,    16 ,      999 ,   0 );//19 - P01
		tk.p20         = new VAProg(    tk         , "P20"   ,  20  ,   120 ,    16 ,    16 ,      999 ,   0 );//20 - P01
		tk.p21         = new VAProg(    tk         , "P21"   ,  21  ,   120 ,    16 ,    16 ,      999 ,   0 );//21 - P01
		tk.p22         = new VAProg(    tk         , "P22"   ,  22  ,   120 ,    16 ,    16 ,      999 ,   0 );//22 - P01
		tk.p23         = new VAProg(    tk         , "P23"   ,  23  ,   120 ,    16 ,    16 ,      999 ,   0 );//23 - P01
		tk.p24         = new VAProg(    tk         , "P24"   ,  24  ,   120 ,    16 ,    16 ,      999 ,   0 );//24 - P01
		tk.p25         = new VAProg(    tk         , "P25"   ,  25  ,   120 ,    16 ,    16 ,      999 ,   0 );//25 - P01
		tk.p26         = new VAProg(    tk         , "P26"   ,  26  ,   120 ,    16 ,    16 ,      999 ,   0 );//26 - P01
		tk.p27         = new VAProg(    tk         , "P27"   ,  27  ,   120 ,    16 ,    16 ,      999 ,   0 );//27 - P01
		tk.p28         = new VAProg(    tk         , "P28"   ,  28  ,   120 ,    16 ,    16 ,      999 ,   0 );//28 - P01
		tk.p29         = new VAProg(    tk         , "P29"   ,  29  ,   120 ,    16 ,    16 ,      999 ,   0 );//29 - P01
		tk.p30         = new VAProg(    tk         , "P30"   ,  30  ,   120 ,    16 ,    16 ,      999 ,   0 );//30 - P01
		tk.p31         = new VAProg(    tk         , "P31"   ,  31  ,   120 ,    16 ,    16 ,      999 ,   0 );//31 - P01
		tk.p32         = new VAProg(    tk         , "P32"   ,  32  ,   120 ,    16 ,    16 ,      999 ,   0 );//32 - P01
	...
	public void initialisierePhasen(){
		...
		tk.MainPhase = tk.PhA = new PhaseA(tk, "PhaseA"            ,    10 , new int[] { 5 }, new int[] { 0 } , true       , new Move[] {tk.k1, tk.k10, tk.k3, tk.pc, tk.pd, tk.pf, tk.ph, tk.Bd, tk.Bh});

		//         					  	 node| name		    | number | skel | is stop in | moves
		//                                   |              |        | len  | Police     | list
		tk.PhB		= new PhaseB        (tk, "PhaseB"		,     20 ,    1 , true       , new Move[] {tk.k4, tk.k5, tk.pa, tk.pc, tk.pe, tk.pg, tk.Bg});
		tk.PhC		= new PhaseC        (tk, "PhaseC"		,     30 ,    1 , true       , new Move[] {tk.k6, tk.pa, tk.pb, tk.pd, tk.pf});
		// Interstages                 
		//                               node| name			|  len | stage out  | stage in
		tk.PhueA_C	 = new PhueAC        (tk, "PhueA_C"		,	12 , tk.PhA		, tk.PhC    );
		tk.PhueC_B   = new PhueCB        (tk, "PhueC_B"		,	15 , tk.PhC 	, tk.PhB    );
		tk.PhueB_A   = new PhueBA        (tk, "PhueB_A"		,	12 , tk.PhB 	, tk.PhA    );
	...
	public void initialisiereUhr(){
		...
		// SUNDAY-THURSDAY
        tk.scheduler.addProgramToSchedule(   0 , 00 ,    2,  true,  true,  true,  true, false, false,  true );
        tk.scheduler.addProgramToSchedule(   1 , 00 ,    4,  true,  true,  true,  true, false, false,  true );
        tk.scheduler.addProgramToSchedule(   6 , 00 ,    1,  true,  true,  true,  true, false, false,  true );
        tk.scheduler.addProgramToSchedule(  10 , 00 ,    2,  true,  true,  true,  true, false, false,  true );
        tk.scheduler.addProgramToSchedule(  11 , 30 ,    3,  true,  true,  true,  true, false, false,  true );
        tk.scheduler.addProgramToSchedule(  20 , 00 ,    2,  true,  true,  true,  true, false, false,  true );

		// FRIDAY
        tk.scheduler.addProgramToSchedule(   0 , 00 ,    2, false, false, false, false,  true, false, false );
        tk.scheduler.addProgramToSchedule(   1 , 00 ,    4, false, false, false, false,  true, false, false );
        tk.scheduler.addProgramToSchedule(   6 , 00 ,    1, false, false, false, false,  true, false, false );
        tk.scheduler.addProgramToSchedule(  10 , 00 ,    2, false, false, false, false,  true, false, false );
        tk.scheduler.addProgramToSchedule(  11 , 30 ,    3, false, false, false, false,  true, false, false );
        tk.scheduler.addProgramToSchedule(  16 , 00 ,    2, false, false, false, false,  true, false, false );

		// SATURDAY
        tk.scheduler.addProgramToSchedule(   0 , 00 ,    2, false, false, false, false, false,  true, false );
        tk.scheduler.addProgramToSchedule(   1 , 00 ,    4, false, false, false, false, false,  true, false );
        tk.scheduler.addProgramToSchedule(  13 , 00 ,    2, false, false, false, false, false,  true, false );
        
		TagesPlan su_thur = new TagesPlan("Su_Thur", tk.p02);
//		su_thur.initProgWunsch( 1 , 00,  tk.p04 );
//		su_thur.initProgWunsch( 6 , 00,  tk.p01 );
//		su_thur.initProgWunsch(10 , 00,  tk.p02 );
//		su_thur.initProgWunsch(11 , 30,  tk.p03 );
//		su_thur.initProgWunsch(20 , 00,  tk.p02 );

		TagesPlan fr = new TagesPlan("Fr", tk.p02);
//		fr.initProgWunsch( 1 , 00,  tk.p04 );
//		fr.initProgWunsch( 6 , 00,  tk.p01 );
//		fr.initProgWunsch(10 , 00,  tk.p02 );
//		fr.initProgWunsch(11 , 30,  tk.p03 );
//		fr.initProgWunsch(16 , 00,  tk.p02 );
		
		TagesPlan sa = new TagesPlan("Sat", tk.p02);
//		sa.initProgWunsch( 1 , 00,  tk.p04 );
//		sa.initProgWunsch(13 , 00,  tk.p02 );

		TagesPlan kipurEve = new TagesPlan("KipurEve", tk.p03);
//		kipurEve.initProgWunsch(17 , 00,  tk.p03 );


		TagesPlan kipur = new TagesPlan("Kipur", tk.p05 );
//		kipur.initProgWunsch( 1 , 00,  tk.p04 );
//		kipur.initProgWunsch( 6 , 00,  tk.p06 );
//		kipur.initProgWunsch(13 , 00,  tk.p05 );
