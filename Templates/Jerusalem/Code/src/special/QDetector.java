...
public class QDetector extends Input {
	...
	public void UpdateState() {		
		...
		currentState = belegt() && (!node.isOffline() && !(((ParametersJerusalem)Var.controller.dvi35Parameters).getDetectors(node, detectorId - 1) == Var.INPUT_DISABLED && this.isSetFromParamsEnabled));
		if (mapInput != null)
			currentState = currentState || mapInput.belegt();
		currentState = currentState || setOnFromParams || setFromCC;
