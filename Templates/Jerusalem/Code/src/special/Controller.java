...
public class Controller {
    ...
    public Input upsActive, upsWeak, upsWarning, upsFailure, upsInBypass, upsNoGridPower, upsDoorClosed;
	...
	public int getMaxProgramsNumber() {
		if (appType.equals(AppType.Haifa) || appType.equals(AppType.NetiveiIsrael) || appType.equals(AppType.Other)) {
			return 19;
		} else if (appType.equals(AppType.Jerusalem)) {
			return 32;
		} else {
			return 19;
		}
