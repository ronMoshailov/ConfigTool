...
//			tk.police_fixed = new MyHandProgramm(tk, "Police", SpecialProgram.Police.getProgramNumber(), 90, 31, 31, 999, 0);
	...
	public void initialisiereUhr() {
		TagesPlan sun_thur = new TagesPlan("Sunday_Thurday",  tk.p02);
)		sun_thur.initProgWunsch( 1 ,  0, tk.p04 );
		sun_thur.initProgWunsch( 6 ,  0, tk.p11 );
		sun_thur.initProgWunsch(14 ,  0, tk.p12 );
		sun_thur.initProgWunsch(21 ,  0, tk.p02 );

		TagesPlan fr = new TagesPlan("Fr",  tk.p02);
)		fr.initProgWunsch( 1 ,  0,  tk.p04 );
		fr.initProgWunsch( 6 ,  0,  tk.p01 );
